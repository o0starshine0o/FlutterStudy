...
@interface FLTSearchReplay ()
+(FLTSearchReplay*)fromMap:(NSDictionary*)dict;
-(NSDictionary*)toMap;
@end
...
@implementation FLTSearchReplay
+(FLTSearchReplay*)fromMap:(NSDictionary*)dict {
  FLTSearchReplay* result = [[FLTSearchReplay alloc] init];
...
void FLTApiSetup(id<FlutterBinaryMessenger> binaryMessenger, id<FLTApi> api) {
  {
    ...
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        ...
        FLTSearchReplay *output = [api search:input error:&error];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [FlutterBasicMessageChannel
        messageChannelWithName:@"dev.flutter.pigeon.Api.startIMActivity"
        binaryMessenger:binaryMessenger];
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        [api startIMActivity:&error];
